...
/**
 * This is an immutable object representaion of a Numeric field. It is used in the 
...
public class NumericField extends Field
{
	 ...
	 */
	public NumericField(String nameIn, int sizeIn, int scaleIn, Constraints constraintsIn)
	{
	 ...
	 * 
	 * @return	the java class cooresponding to this field (NUMERIC)
	 */
	...
	/**
	 * Returns the max scale allowed by this field 
         *
...
/*
	...
	{
		NumericField test1 = new NumericField("mytest",5,  2, new Constraints(true, true, true, true));
		NumericField test2 = new NumericField("mytest",5,  2, new Constraints(true, true, true, true));
		NumericField test3 = new NumericField("mytest2",5,  3, new Constraints(false, false, false, false));
