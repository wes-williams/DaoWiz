...
/**
 * This is an immutable object representaion of a Timestamp field. It is used in the 
...
public class TimeStampField extends Field
{
	 ...
	 */
	public TimeStampField(String nameIn, Constraints constraintsIn)
	{
	...
	/**
         ...
         *
	 * @return 	the corresponding value defined in java.sql.Types (TIMESTAMP)
	 */
	...
	/**
         ...
         *
	 * @return	the java class cooresponding to this field (Timestamp)
	 */
...
/*	
	...
	{
		TimeStampField test1 = new TimeStampField("mytest", new Constraints(true, true, true, true));
		TimeStampField test2 = new TimeStampField("mytest", new Constraints(true, true, true, true));
		TimeStampField test3 = new TimeStampField("mytest2", new Constraints(false, false, false, false));
		...
		if (test1.isValid(new Timestamp(System.currentTimeMillis())))
