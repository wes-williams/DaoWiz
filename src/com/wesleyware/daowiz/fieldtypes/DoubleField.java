...
/**
 * This is an immutable object representaion of a Double field. It is used in the
...
public class DoubleField extends Field
{
     ...
     */
    public DoubleField(String nameIn, Constraints constraintsIn)
    {
    ...
    {
        if (value == null || this.getContraints().isNotNull() && value == null)
            return false;
...
/*
        ...
        {
                DoubleField test1 = new DoubleField("mytest", new Constraints(true, true, true, true));
                DoubleField test2 = new DoubleField("mytest", new Constraints(true, true, true, true));
                DoubleField test3 = new DoubleField("mytest2", new Constraints(false, false, false, false));
