 ...
 */
public abstract class VendorDaoBase extends RecordDao
{
   ...
   * @throws SQLException
   */
   public boolean exist(Connection conn, VendorBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public int save(Connection conn, VendorBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public boolean create(Connection conn, VendorBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int update(Connection conn, VendorBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int delete(Connection conn, VendorBase record) throws SQLException
   {
    ...
    */
   public int updatePK(Connection conn, VendorBase oldRecord, Vendor newRecord) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public boolean load(Connection conn, VendorBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public List search(Connection conn, VendorBase searchRecord, boolean exact) throws SQLException
   {
