 ...
 */
public abstract class VendorBase extends Record implements Cloneable
{
   protected final static VendorDao DAO =  new VendorDao();

   protected final static String DB_TABLE_NAME = "vendors";

   /**
    *vendor abbreviation
    */
   public final static VarCharField VENDORID = new VarCharField("vendor_id",10,new Constraints(true, true, false, false));
   /**
    *vendor name
    */
   public final static VarCharField VENDORNAME = new VarCharField("vendor_name",50,new Constraints(true, false, false, false));
   /**
    *street address
    */
   ...
   /**
    *employee assigned to vendor relations
    */
   ...
   {
      VENDORID,VENDORNAME,ADDRESS,ADDRESS2,
    ...
    */
   public VendorBase(String vendorId) throws InvalidPkException
   {
      if(!setVendorId(vendorId) )
   ...
   /**
    * setter for vendor abbreviation
    *
   ...
   /**
    * getter for vendor abbreviation
    *
    ...
    *
    * @param   value ofvendorName
    * @return  true if valid
    */
   public boolean setVendorName(String vendorName)
   {
      return set(VENDORNAME,vendorName);
   }

   /**
    * getter for vendor name
    *
    * @return   value ofvendorName
    */
   ...
   /**
    * setter for employee assigned to vendor relations
    *
   ...
   /**
    * primitive value setter for employee assigned to vendor relations
    *
    * @param   value ofassignedEmployeeId
    * @return  true if valid
    */
   ...
   /**
    * getter for employee assigned to vendor relations
    *
   ...
   /**
    * primitive getter for employee assigned to vendor relations
    *
    * @return   value ofassignedEmployeeId
    */
