 ...
 */
public abstract class CompanyVendorDaoBase extends RecordDao
{
   ...
   * @throws SQLException
   */
   public boolean exist(Connection conn, CompanyVendorBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public int save(Connection conn, CompanyVendorBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public boolean create(Connection conn, CompanyVendorBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int update(Connection conn, CompanyVendorBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int delete(Connection conn, CompanyVendorBase record) throws SQLException
   {
    ...
    */
   public int updatePK(Connection conn, CompanyVendorBase oldRecord, CompanyVendor newRecord) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public boolean load(Connection conn, CompanyVendorBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public List search(Connection conn, CompanyVendorBase searchRecord, boolean exact) throws SQLException
   {
