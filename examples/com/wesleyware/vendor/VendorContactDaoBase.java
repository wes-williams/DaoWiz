 ...
 */
public abstract class VendorContactDaoBase extends RecordDao
{
   ...
   * @throws SQLException
   */
   public boolean exist(Connection conn, VendorContactBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public int save(Connection conn, VendorContactBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public boolean create(Connection conn, VendorContactBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int update(Connection conn, VendorContactBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int delete(Connection conn, VendorContactBase record) throws SQLException
   {
    ...
    */
   public int updatePK(Connection conn, VendorContactBase oldRecord, VendorContact newRecord) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public boolean load(Connection conn, VendorContactBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public List search(Connection conn, VendorContactBase searchRecord, boolean exact) throws SQLException
   {
