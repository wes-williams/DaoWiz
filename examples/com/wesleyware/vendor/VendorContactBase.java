 ...
 */
public abstract class VendorContactBase extends Record implements Cloneable
{
   protected final static VendorContactDao DAO =  new VendorContactDao();

   protected final static String DB_TABLE_NAME = "vendor_contacts";

   /**
    *auto generated id for vendor contact
    */
   public final static IntField VENDORCONTACTID = new IntField("vendor_contact_id",new Constraints(true, true, false, true));
   /**
    *referenced vendor
    */
   public final static VarCharField VENDORID = new VarCharField("vendor_id",10,new Constraints(true, false, true, false));
   /**
    *department
    */
   ...
   /**
    *vendor status (A = Active, I =Inactive)
    */
   ...
   {
      VENDORCONTACTID,VENDORID,DEPARTMENT,FIRSTNAME,
    ...
    */
   public VendorContactBase(Integer vendorContactId) throws InvalidPkException
   {
      if(!setVendorContactId(vendorContactId) )
   ...
   /**
    * setter for auto generated id for vendor contact
    *
    * @param   value ofvendorContactId
    * @return  true if valid
    */
   public boolean setVendorContactId(Integer vendorContactId)
   {
      return set(VENDORCONTACTID,vendorContactId);
   }

   /**
    * primitive value setter for auto generated id for vendor contact
    *
    * @param   value ofvendorContactId
    * @return  true if valid
    */
   public boolean setVendorContactId(int vendorContactId)
   {
      return set(VENDORCONTACTID,vendorContactId);
   }

   /**
    * getter for auto generated id for vendor contact
    *
    * @return   value ofvendorContactId
    */
   public Integer getVendorContactIdObject()
   {
      return get(VENDORCONTACTID);
   }

   /**
    * primitive getter for auto generated id for vendor contact
    *
    * @return   value ofvendorContactId
    */
   public int getVendorContactId()
   {
      return getPrimitive(VENDORCONTACTID);
   }

   /**
    * setter for referenced vendor
    *
   ...
   /**
    * setter for vendor status (A = Active, I =Inactive)
    *
   ...
   /**
    * getter for vendor status (A = Active, I =Inactive)
    *
   ...
   public Object clone()
   {
      VendorContact clone = new VendorContact();
      copyTo(clone);
      return clone;
   }
