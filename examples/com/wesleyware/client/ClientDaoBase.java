 ...
 */
public abstract class ClientDaoBase extends RecordDao
{
   ...
   * @throws SQLException
   */
   public boolean exist(Connection conn, ClientBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public int save(Connection conn, ClientBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public boolean create(Connection conn, ClientBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int update(Connection conn, ClientBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int delete(Connection conn, ClientBase record) throws SQLException
   {
    ...
    */
   public int updatePK(Connection conn, ClientBase oldRecord, Client newRecord) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public boolean load(Connection conn, ClientBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public List search(Connection conn, ClientBase searchRecord, boolean exact) throws SQLException
   {
