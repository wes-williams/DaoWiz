...
import com.wesleyware.client.Client;

/**
 * contacts for clients
 */
public class ClientContact extends ClientContactBase
{
     ...
     */
    public ClientContact(Integer clientContactId)  throws InvalidPkException
    {
     ...
     * throws InvalidPkException
     */
    public ClientContact(int clientContactId)  throws InvalidPkException
    {
        this( new Integer(clientContactId));
    }
