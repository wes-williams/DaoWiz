 ...
 */
public abstract class CompanyClientDaoBase extends RecordDao
{
   ...
   * @throws SQLException
   */
   public boolean exist(Connection conn, CompanyClientBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public int save(Connection conn, CompanyClientBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public boolean create(Connection conn, CompanyClientBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int update(Connection conn, CompanyClientBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int delete(Connection conn, CompanyClientBase record) throws SQLException
   {
    ...
    */
   public int updatePK(Connection conn, CompanyClientBase oldRecord, CompanyClient newRecord) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public boolean load(Connection conn, CompanyClientBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public List search(Connection conn, CompanyClientBase searchRecord, boolean exact) throws SQLException
   {
