 ...
 */
public abstract class CompanyDaoBase extends RecordDao
{
   ...
   * @throws SQLException
   */
   public boolean exist(Connection conn, CompanyBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public int save(Connection conn, CompanyBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public boolean create(Connection conn, CompanyBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int update(Connection conn, CompanyBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int delete(Connection conn, CompanyBase record) throws SQLException
   {
    ...
    */
   public int updatePK(Connection conn, CompanyBase oldRecord, Company newRecord) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public boolean load(Connection conn, CompanyBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public List search(Connection conn, CompanyBase searchRecord, boolean exact) throws SQLException
   {
