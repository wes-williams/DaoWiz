 ...
 */
public abstract class DepartmentDaoBase extends RecordDao
{
   ...
   * @throws SQLException
   */
   public boolean exist(Connection conn, DepartmentBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public int save(Connection conn, DepartmentBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public boolean create(Connection conn, DepartmentBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int update(Connection conn, DepartmentBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int delete(Connection conn, DepartmentBase record) throws SQLException
   {
    ...
    */
   public int updatePK(Connection conn, DepartmentBase oldRecord, Department newRecord) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public boolean load(Connection conn, DepartmentBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public List search(Connection conn, DepartmentBase searchRecord, boolean exact) throws SQLException
   {
