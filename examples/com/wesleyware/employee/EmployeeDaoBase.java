 ...
 */
public abstract class EmployeeDaoBase extends RecordDao
{
   ...
   * @throws SQLException
   */
   public boolean exist(Connection conn, EmployeeBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public int save(Connection conn, EmployeeBase record) throws SQLException
   {
   ...
   * @throws SQLException
   */
   public boolean create(Connection conn, EmployeeBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int update(Connection conn, EmployeeBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public int delete(Connection conn, EmployeeBase record) throws SQLException
   {
    ...
    */
   public int updatePK(Connection conn, EmployeeBase oldRecord, Employee newRecord) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public boolean load(Connection conn, EmployeeBase record) throws SQLException
   {
    ...
    * @throws SQLException
    */
   public List search(Connection conn, EmployeeBase searchRecord, boolean exact) throws SQLException
   {
